...
This repository describes an easy implementation and application of Recurrent Neural Network. I used `keras` as deep learning library with "Using Tensorflow Backend" on CPU (yep!). So here's what we have: 
